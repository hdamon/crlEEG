...
% Check that both objects are crlEEG.basicobj.gridInSpace objects
if ~(isa(gridIn,'crlEEG.basicobj.gridInSpace')&&isa(gridOut,'crlEEG.basicobj.gridInSpace'))
...
%
% This is only done because of the way the underlying crlEEG.basicobj.grid
...
% Get Mapping
mapOut = getMapping@crlEEG.basicobj.grid(gridIn,gridOut,mapType);
